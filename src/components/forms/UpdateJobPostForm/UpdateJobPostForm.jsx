...
const UpdateJobPostForm = ({ jobPostData, onCancel }) => {
    const {
        ...
        mode: "onChange",
        defaultValues: {
            ...jobPostData, // Pre-fill form với dữ liệu job
            majors: jobPostData.majors || [],
            type: jobPostData.type || "",
            remote: jobPostData.remote || "",
        },
    });
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="mx-auto max-w-4xl p-6">
            ...
            <div className="mt-6 flex justify-end space-x-4">
                <button
                    type="submit"
                    className="rounded-lg bg-blue-800 px-6 py-2 font-semibold text-white hover:bg-blue-900"
                >
