    ...
    return (
        <div style={{ maxHeight: "200px", overflowY: "auto", marginBottom: "16px", textAlign: "left" }}>
            <p>
                ...
                <br />
                Trước khi sử dụng trang web InternHub bạn cần đọc kỹ và cẩn thận nội dung thỏa thuận sử dụng của
                InternHub. Khi bạn truy cập và sử dụng trang web InternHub xem như bạn đã chấp nhận thỏa thuận sử dụng.
                <br />
                <br />
                InternHub được phép hiệu chỉnh các Điều Khoản Thỏa Thuận và có hiệu lực ngay sau khi cập nhật lại trang
                này. Vì vậy bạn nên truy cập định kỳ vào trang này để cập nhật những Điều Khoản mới của InternHub. Những
                thuật ngữ Bạn và Người sử dụng được dùng ở đây đề cập đến tất cả những cá nhân hoặc những tổ chức truy
            ...
            <p>
                ...
                ero@hcmute.edu.vn <br /> Nếu thành viên là Doanh nghiệp/Đối tác gửi email về địa chỉ: pr@hcmute.edu.vn
                <br /> + Bước 2: Bộ phận phụ trách của phòng Quan hệ Doanh nghiệp sẽ tiếp nhận các phản ánh của thành
                viên. Bộ phận này chủ động giải quyết nhanh chóng và trả lời kết quả giải quyết các khiếu nại trên cơ sở
                các Chính sách mà nền tảng đã công bố.
                <br /> + Bước 3: Tùy theo mức độ sai phạm Quản trị viên sẽ đưa ra biện pháp xử lý phù hợp.Trong trường
                hợp 2 bên không đi đến được tiếng nói chung qua thương lượng.
                <br />
                ...
                có thẩm quyền can thiệp nhằm đảm bảo lợi ích hợp pháp của các bên.
            </p>
        </div>
    );
};
