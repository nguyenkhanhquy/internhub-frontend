...
const JobCardSearch = ({
    ...
    return (
        ...
        >
            {/* Logo công ty */}
            <Box sx={{ width: { xs: 80, sm: 140, md: 150, lg: 160 }, mr: 2 }}>
                <Avatar
                    src={logo}
            ...
            {/* Nội dung công việc */}
            <Box sx={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "space-between", pb: 1 }}>
                {/* Tiêu đề công việc và nút lưu */}
                <Box display="flex" alignItems="center" justifyContent="space-between">
                    <Typography fontWeight="bold" sx={{ fontSize: "1.2rem", color: "#1976d2" }}>
                        {title}
                    </Typography>
                    <IconButton
                        onClick={(event) => {
