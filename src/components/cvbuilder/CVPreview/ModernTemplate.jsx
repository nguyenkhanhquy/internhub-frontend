...
const ModernTemplate = ({ cvData }) => {
    ...
    return (
        <div className="relative flex flex-col items-center">
            <div ref={cvRef} className="mx-auto w-full max-w-4xl bg-white shadow-lg print:p-0 print:shadow-none">
                ...
                <div className="p-8">
                    ...
                    {personalInfo.summary && (
                        <div className="mb-8">
                            <h2 className="mb-4 border-b-2 border-teal-700 pb-2 text-xl font-bold text-teal-700">
                                Tóm tắt
                            </h2>
                            ...
                            {experience.map((exp, index) => (
                                <div key={index} className="mb-6">
                                    <div className="mb-2 flex flex-col md:flex-row md:items-start md:justify-between">
                                        ...
                                        <p className="mt-1 text-sm text-gray-500 italic md:mt-0">
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                        {skills.technical.length > 0 && (
                            <div>
                                <h2 className="mb-3 border-b-2 border-teal-700 pb-2 text-lg font-bold text-teal-700">
                                    Kỹ năng chuyên môn
                                </h2>
            ...
            <button
                onClick={exportToPDF}
                className="mt-8 flex items-center rounded-lg bg-teal-600 px-8 py-3 text-lg font-semibold text-white shadow-md transition-colors hover:bg-teal-700"
                aria-label="Xuất PDF"
            >
                <svg
